...
| MISO         | Master in Slave out. Slave sends command or data to Master. <br /> We don't use this in our case. We don't need to get <br /> data from the LCD. (If you use touchscreen, you would need this function)
